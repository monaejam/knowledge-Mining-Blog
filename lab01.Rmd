...
```{r}
length(x)  # What does length() do? # gives the length 
length(y)
...
ls()
rm(list=ls()) # Danger! What does this do? remove the lists 
```
...
matrix(c(1,2,3,4),2,2,byrow=FALSE) # What about byrow=F? False makes the two first as a column 
...
y=x+rnorm(50,mean=50,sd=.1) # What does rnorm(50,mean=50,sd=.1) generate? vector x + 50
